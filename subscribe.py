...
def main():
    ...
    templates = [
        NodeTemplate("🇺🇸美国-专线", "vless", "vless://5f4638b2-cf76-4f59-92a7-bdd5ad53e010@ip:port?encryption=none&security=tls&sni=rnxhttp.256800.xyz&fp=chrome&insecure=0&allowInsecure=0&type=xhttp&path=%2F5f4638b2&mode=auto#NodeName"),
        # 未来可以直接加：
